...
public class secondlevel {
	...
	public secondlevel(){
		img = getImage("/imgs/secondlevel.png"); //load the image for Tree
	...
	public secondlevel(String fileName) {
		img = getImage("/imgs/secondlevel.png"+ fileName); //load the image for Tree
		tx = AffineTransform.getTranslateInstance(x, y);
