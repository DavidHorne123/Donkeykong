...
public class fourthlevel {
	...
	public fourthlevel(){
		img = getImage("/imgs/fourthlevel.png"); //load the image for Tree
		tx = AffineTransform.getTranslateInstance(x, y);
		init(250, 180); 				//initialize the location of the image
									//use your variables
	}
	...
	public fourthlevel(String fileName) {
		img = getImage("/imgs/fourthlevel.png"+ fileName); //load the image for Tree
		tx = AffineTransform.getTranslateInstance(x, y);
